...
try {
    ...
    $mail->Body.='<p style="font-size: 25px;text-align: center;text-transform:capitalize;font-weight: 800;margin:0; color:#ed1c24">Enquiry Form</p>';
...
header("Location: http://localhost/Wind_new/index.php");
exit();
